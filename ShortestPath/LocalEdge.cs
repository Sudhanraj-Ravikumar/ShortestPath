...
namespace ShortestPath
{
    class LocalEdge : IEdge
    {
        ...
        //    int disclength, radius;

        //    radius = 3;
        //    disclength = 45;
        //    //disclength = (int)(Math.PI * (radius * radius));
        //    List<Tuple<Node, Node>> nodeswithedges = new List<Tuple<Node, Node>>();

        //    nodeswithedges = GenerateRandomedges(vertices, disclength);

        //    return nodeswithedges;
        //}

        //private List<Tuple<Node, Node>> GenerateRandomedges(IList<Node> vertices, int disclength)
        //{
        //    Random randomnumber = new Random();
        ...
        //        {
        //            if (vertices[i].X + disclength > vertices[j].X && vertices[i].X - disclength < vertices[j].X)
        //            {
        //                if (vertices[i].Y + disclength > vertices[j].Y && vertices[i].Y - disclength < vertices[j].Y)
        //                {
        //                    AddEdges(vertices[i], vertices[j]);
        //                }
        //            }

        //        }
        //    }
        //    if (LocalIncidentEdges?.Count > 0)
        //    {
        //        return LocalIncidentEdges;
        //    }
        //    else
